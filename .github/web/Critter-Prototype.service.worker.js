...
/** @type {string} */
const CACHE_VERSION = '1758302013|26139451';
/** @type {string} */
const CACHE_PREFIX = 'Critter-Prototyp-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Critter-Prototype.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Critter-Prototype.html","Critter-Prototype.js","Critter-Prototype.offline.html","Critter-Prototype.icon.png","Critter-Prototype.apple-touch-icon.png","Critter-Prototype.audio.worklet.js","Critter-Prototype.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Critter-Prototype.wasm","Critter-Prototype.pck"];
